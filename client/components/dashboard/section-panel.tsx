...
export function SectionPanel({ eyebrow, title, description, children }: SectionPanelProps) {
  return (
    <section className="surface-panel rounded-[28px] p-5 sm:rounded-[32px] sm:p-7">
      <p className="text-[11px] font-semibold uppercase tracking-[0.26em] text-[var(--primary)]">{eyebrow}</p>
      <h2 className="mt-3 text-xl font-semibold tracking-tight text-[var(--foreground)] sm:text-2xl">{title}</h2>
